...
- [0-shell](https://github.com/pjtunstall/0-shell)* (2025) A BusyBox-style standalone shell that re-implements some core Unix tools from scratch as internal functions, and features job-control.
