...
- [mad](https://github.com/pjtunstall/mad) The Mad Bomber's Tea Party. Bomberman clone with a Node backend and browser-based clients. The code is naively structured and there are outstanding issues as detailed in the docs. But I still like the story and AI art. This was an 01Founders project to make a multi-player browser game using web sockets, and no WebGL or any framework except one we made in an earlier project. Based on a single-player version by fellow students; see credits in game and in the README.
